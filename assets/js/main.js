...
const christmasCountdown = () =>{
    ...
    let nextChristmasDay = `Dec 25, ${nextChristmasYear} 00:00:00`
        christmasDay = new Date(nextChristmasDay),
        timeLeft = christmasDay - now // Calculate the difference in milliseconds
    let days = 0,
        hours = 0,
        minutes = 0,
        seconds = 0
...
shareButton.forEach(n => n.addEventListener('click', openMessageApp))
